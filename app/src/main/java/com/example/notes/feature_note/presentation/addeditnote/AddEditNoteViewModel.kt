...
@Inject constructor(private val useCases: UseCases, savedStateHandle: SavedStateHandle) :
    ViewModel() {

    private val _noteTitle = mutableStateOf(NoteTextFieldState(hint = "Add Title"))
    ...
    fun onEvent(event: AddEditNoteEvent) {
        when (event) {
            ...
            AddEditNoteEvent.SaveNote -> {
                viewModelScope.launch {
                    try {
                        Log.d("TAG", "AddEditNoteScreen: ${noteTitle.value.text}")
